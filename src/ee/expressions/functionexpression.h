...
static const int FUNC_TRIM_CHAR                        = 31;
...
static const int FUNC_LTRIM                    = 118;
...
static const int FUNC_RTRIM                    = 139;
...
static const int SQL_TRIM                       =  23; // FIXME: rename this SQL_BOTH for Tokens.BOTH
...
static const int SQL_LTRIM                      = 151; // FIXME: rename this SQL_LEADING for Tokens.LEADING
static const int SQL_MONTH_NAME                 = 708;
static const int SQL_QUARTER                    = 722;
static const int SQL_RTRIM                      = 286; // FIXME: rename this SQL_TRAILING for Tokens.TRAILING
